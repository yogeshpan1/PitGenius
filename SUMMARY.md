...
| Undercut/overcut calculator | ⚠️ Built + backtested — **beats constant guessing, not yet prior-kind baselines** | D22 fixes 1–5 done: orientation bug fixed (was literally inverted, corr −0.328), multi-lap physics + temporal calibration added. All-pairs n=1852: Brier 0.5005 → **0.1295** vs constant baseline 0.1373 (✅ beaten) and non-leaky kind baseline 0.1270 (❌ not yet). Details: `reports/undercut_backtest.json` + DECISIONS.md D22 |
